...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/vincentherbst/Dev/JellySeeTV/Vendor/FFmpeg/build/output-appletvos --enable-cross-compile --arch=arm64 --target-os=darwin --cc=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/AppleTVOS.platform/Developer/SDKs/AppleTVOS26.4.sdk --extra-cflags='-arch arm64 -mappletvos-version-min=16.0 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/AppleTVOS.platform/Developer/SDKs/AppleTVOS26.4.sdk -fembed-bitcode' --extra-ldflags='-arch arm64 -mappletvos-version-min=16.0 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/AppleTVOS.platform/Developer/SDKs/AppleTVOS26.4.sdk' --disable-programs --disable-doc --disable-debug --disable-autodetect --enable-pic --enable-static --disable-shared --enable-small --enable-demuxer='matroska,mov,avi,mpegts,webm_dash_manifest,flv,ogg,wav,mp3,aac,flac' --enable-demuxer='srt,ass,webvtt' --enable-muxer=null --enable-decoder='aac,ac3,eac3,dts,flac,opus,mp3,truehd,vorbis' --enable-decoder='pcm_s16le,pcm_s24le,pcm_f32le,pcm_alaw,pcm_mulaw' --enable-decoder='h264,hevc,mpeg2video,mpeg4,vp8,vp9,av1,theora,vc1,wmv3' --enable-decoder='srt,ass,ssa,webvtt,subrip,pgssub,dvdsub,dvbsub' --enable-parser='h264,hevc,aac,ac3,dts,flac,opus,mpegaudio,vorbis,vp8,vp9,av1' --enable-protocol='http,https,file,tcp,tls' --enable-securetransport --enable-filter='aresample,aformat,anull,null' --enable-swresample --enable-avformat --enable-avcodec --enable-avutil --disable-swscale --disable-avdevice --disable-avfilter --disable-postproc --enable-videotoolbox --enable-hwaccel='h264_videotoolbox,hevc_videotoolbox'
...
CC_IDENT=Apple clang version 21.0.0 (clang-2100.0.123.102)
ARCH=aarch64
INTRINSICS=neon
EXTERN_PREFIX=_
...
OBJCC=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang
...
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/AppleTVOS.platform/Developer/SDKs/AppleTVOS26.4.sdk -D_ISOC11_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -DPIC -I$(SRC_PATH)/compat/stdbit
CFLAGS=  -arch arm64 -mappletvos-version-min=16.0 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/AppleTVOS.platform/Developer/SDKs/AppleTVOS26.4.sdk -fembed-bitcode -std=c17 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Oz -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -arch arm64 -mappletvos-version-min=16.0 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/AppleTVOS.platform/Developer/SDKs/AppleTVOS26.4.sdk -fembed-bitcode -fPIC -Qunused-arguments
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -arch arm64 -mappletvos-version-min=16.0 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/AppleTVOS.platform/Developer/SDKs/AppleTVOS26.4.sdk  --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/AppleTVOS.platform/Developer/SDKs/AppleTVOS26.4.sdk -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avformat=-lm -framework CoreFoundation -framework Security
EXTRALIBS-avcodec=-lm -pthread -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo
